...
C {devices/vsource.sym} -750 -630 0 0 {name=Vres value="dc 0 pwl(0, \{vdd\}, \{per/4\}, \{vdd\}, \{per/4+50p\}, 0)"}
C {devices/lab_wire.sym} -750 -700 0 0 {name=p27 sig_type=std_logic lab=res}
C {devices/gnd.sym} -930 -110 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} -930 -160 0 0 {name=Vp3 value="dc 0 pulse(\{vdd\}, 0, \{per/2\}, 100p, 100p, \{per/2\}, \{per\}) "}
...
C {devices/vsource.sym} -140 -290 0 0 {name=Vd value="dc \{vdd\} pwl(0, 0, 105n, 0, 105.1n, \{vdd\})"}
